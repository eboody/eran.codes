...
4. Identify friction points:
   ...
   - weak error recovery
   - copy length/density that obscures scanability
...
8. Validate interactability and intelligibility with fresh proof:
   - verify controls can be operated by click and keyboard
   - verify state transitions are visible and understandable
   - verify screenshots include each reviewed interaction state
...
- When matching a reference UI, align text cadence and brevity to the reference interaction model.
...
- If a visual change is intentional, require baseline refresh and report that it was done.
