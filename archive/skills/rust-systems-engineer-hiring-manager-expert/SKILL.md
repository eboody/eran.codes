...
- `interaction_correctness_verdict`: click + keyboard flow verdict with failure points
- `operational_intelligibility_verdict`: whether maintainers can reason about state quickly
- `change_risk_verdict`: decomposition and blast-radius assessment
