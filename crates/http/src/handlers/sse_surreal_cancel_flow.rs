...
#[machine]
pub(super) struct SurrealCancelFlow<SurrealCancelState> {
    state: crate::State,
...
#[transition]
impl SurrealCancelFlow<Incoming> {
    pub(super) fn prepare_token(self) -> SurrealCancelFlow<TokenPrepared> {
...
impl SurrealCancelFlow<TokenPrepared> {
    pub(super) fn spawn(self) -> SurrealCancelFlow<Spawned> {
...
pub(super) type IncomingFlow = SurrealCancelFlow<Incoming>;
