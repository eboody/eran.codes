...
pub async fn login_form(
    ...
    let incoming = super::auth_page_gate_flow::IncomingFlow::from_query(
        super::auth_page_gate_flow::AuthPageKind::Login,
        query.next,
...
pub async fn register_form(
    ...
    let incoming = super::auth_page_gate_flow::IncomingFlow::from_query(
        super::auth_page_gate_flow::AuthPageKind::Register,
        query.next,
        auth_session.user.is_some(),
    );
    let sanitized = incoming.sanitize_next();
...
pub async fn protected(
    ...
    let incoming = super::auth_protected_flow::IncomingFlow::from_session(auth_session);
