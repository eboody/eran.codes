...
let $ = { // Convenience for internals.
    ...
    // Send / trigger event.
    // Vanilla: Events Dispatch: document.querySelector(".thing").dispatchEvent(new Event('click'))
    ...
    // Used internally. Is this an element / node?
    isNode(e) {
        return (e instanceof HTMLElement || e instanceof SVGElement || e instanceof Document) ? true : false
    },
    // Used internally by DOM functions. Is this a list of elements / nodes?
    isNodeList(e) {
        return (e instanceof NodeList || Array.isArray(e)) ? true : false
    },
    // Used internally by DOM functions. Warning when selector is invalid. Likely missing a "#" or "."
