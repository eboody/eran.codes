<!-- Generated from docs.rs rustdoc HTML: https://docs.rs/strum/latest/strum/trait.AsStaticRef.html -->
...
# Trait AsStaticRef Copy item path
...
{
    // Required method
    fn [as_static][42](&self) -> [&'static T][43];
}
```

👎Deprecated since 0.22.0: please use `#[derive(IntoStaticStr)]` instead
...
## Implementors[§][39]
   ...
   [1]: https://docs.rs/
   [2]: trait.AsStaticRef.html# (Helpful macros for working with enums and strings)
   [3]: https://docs.rs/strum/0.28.0/strum/trait.AsStaticRef.html (Get a link to this specific version)
   ...
   [13]: trait.AsStaticRef.html#
   [14]: https://docs.rs/crate/strum/latest/target-redirect/aarch64-apple-darwin/strum/trait.AsStaticRef.html
   [15]: https://docs.rs/crate/strum/latest/target-redirect/aarch64-unknown-linux-gnu/strum/trait.AsStaticRef.html
   [16]: https://docs.rs/crate/strum/latest/target-redirect/i686-pc-windows-msvc/strum/trait.AsStaticRef.html
   [17]: https://docs.rs/crate/strum/latest/target-redirect/x86_64-pc-windows-msvc/strum/trait.AsStaticRef.html
   [18]: https://docs.rs/crate/strum/latest/target-redirect/strum/trait.AsStaticRef.html
   ...
   [35]: trait.AsStaticRef.html#main-content
   [36]: index.html
   [37]: trait.AsStaticRef.html#required-methods
   [38]: trait.AsStaticRef.html#tymethod.as_static (as_static)
   [39]: trait.AsStaticRef.html#implementors
   [40]: https://docs.rs/strum/latest/src/strum/lib.rs.html#195-200
   [41]: https://doc.rust-lang.org/nightly/core/marker/trait.Sized.html (trait core::marker::Sized)
   [42]: trait.AsStaticRef.html#tymethod.as_static
   [43]: https://doc.rust-lang.org/nightly/std/primitive.reference.html
   [44]: https://docs.rs/strum/latest/src/strum/lib.rs.html#199
