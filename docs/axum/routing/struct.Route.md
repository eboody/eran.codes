<!-- Generated from rustdoc HTML: routing/struct.Route.html -->
...
# Struct Route Copy item path

[Source][4]
``` 
pub struct Route<E = [Infallible][5]>(/* private fields */);
```

Expand description

How routes are stored inside a [`Router`][6].

You normally shouldn’t need to care about this type. It’s used in [`Router::layer`][7].

## Trait Implementations§

[Source][8]§

### impl<E> [Clone][9] for [Route][10]<E>
...
### impl<E> [Debug][16] for [Route][10]<E>
...
### impl<B, E> Service<Request<B>> for [Route][10]<E>
...
### impl<E> [Freeze][37] for [Route][10]<E>

§

### impl<E = [Infallible][5]> ![RefUnwindSafe][38] for [Route][10]<E>

§

### impl<E> [Send][22] for [Route][10]<E>

§

### impl<E> [Sync][39] for [Route][10]<E>

§

### impl<E> [Unpin][40] for [Route][10]<E>

§

### impl<E = [Infallible][5]> ![UnwindSafe][41] for [Route][10]<E>
...
where Self: [Sized][44], Error: [From][64]<Self::Error>, F: [FnOnce][93]([Result][33]<Self::Response, Self::Error>) -> [Result][33]<Response, Error> \+ [Clone][9],
...
where Self: [Sized][44], Error: [From][64]<Self::Error>, F: [FnOnce][93]([Result][33]<Self::Response, Self::Error>) -> Fut + [Clone][9], Fut: [Future][98]<Output = [Result][33]<Response, Error>>,
...
where Self: [Sized][44], F: [FnMut][94](Self::Future) -> Fut, Error: [From][64]<Self::Error>, Fut: [Future][98]<Output = [Result][33]<Response, Error>>,
...
#### type [Error][116] = [Infallible][5]

The type returned in the event of a conversion error.

[Source][117]§

#### fn [try_from][118](value: U) -> [Result][33]<T, <T as [TryFrom][114]<U>>::[Error][119]>
...
#### fn [try_into][125](self) -> [Result][33]<U, <U as [TryFrom][114]<T>>::[Error][119]>
...
Attaches the current [default][127] [`Subscriber`][126] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: ../../src/axum/routing/route.rs.html#31
   ...
   [8]: ../../src/axum/routing/route.rs.html#75-80
   ...
   [11]: ../../src/axum/routing/route.rs.html#77-79
   ...
   [21]: ../../src/axum/routing/route.rs.html#88-106
   ...
   [25]: ../../src/axum/routing/route.rs.html#93
   [26]: ../body/struct.Body.html (struct axum::body::Body)
   [27]: ../../src/axum/routing/route.rs.html#94
   [28]: ../../src/axum/routing/route.rs.html#95
   [29]: future/struct.RouteFuture.html (struct axum::routing::future::RouteFuture)
   [30]: ../../src/axum/routing/route.rs.html#98-100
   ...
   [35]: ../../src/axum/routing/route.rs.html#103-105
