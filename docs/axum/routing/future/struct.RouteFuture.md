<!-- Generated from rustdoc HTML: routing/future/struct.RouteFuture.html -->
...
# Struct RouteFuture Copy item path
...
Response future for [`Route`][6].

## Trait Implementations§

[Source][7]§

### impl<E> [Future][8] for [RouteFuture][9]<E>

[Source][10]§

#### type [Output][11] = [Result][12]<Response<[Body][13]>, E>
...
### impl<'__pin, E> [Unpin][20] for [RouteFuture][9]<E>

where PinnedFieldsOf<__Origin<'__pin, E>>: [Unpin][20],

## Auto Trait Implementations§

§

### impl<E> ![Freeze][21] for [RouteFuture][9]<E>

§

### impl<E> ![RefUnwindSafe][22] for [RouteFuture][9]<E>

§

### impl<E> [Send][23] for [RouteFuture][9]<E>

§

### impl<E> ![Sync][24] for [RouteFuture][9]<E>

§

### impl<E> ![UnwindSafe][25] for [RouteFuture][9]<E>
...
where F: [FnOnce][45](Self::[Output][19]) -> Fut, Fut: [Future][8], Self: [Sized][28],
...
where B: [Future][8]<Output = Self::[Output][19]>, Self: [Sized][28],
...
where A: [Future][8]<Output = Self::[Output][19]>, Self: [Sized][28],
...
where Self::[Output][19]: [Future][8], Self: [Sized][28],
...
#### fn boxed<'a>(self) -> [Pin][16]<[Box][48]<dyn [Future][8]<Output = Self::[Output][19]> \+ [Send][23] \+ 'a>>
...
#### fn boxed_local<'a>(self) -> [Pin][16]<[Box][48]<dyn [Future][8]<Output = Self::[Output][19]> \+ 'a>>
...
Turns a [`Future<Output = T>`][8] into a [`TryFuture<Ok = T, Error = ()`>][49].
...
Turns a [`Future<Output = T>`][8] into a [`TryFuture<Ok = T, Error = Never`>][49].
...
#### type [Output][59] = <F as [Future][8]>::[Output][19]
...
#### fn [try_from][80](value: U) -> [Result][12]<T, <T as [TryFrom][75]<U>>::[Error][81]>
...
where F: [Future][8]<Output = [Result][12]<T, E>> \+ ?[Sized][28],
...
#### fn try_poll( self: [Pin][16]<[&mut F][36]>, cx: &mut [Context][17]<'_>, ) -> [Poll][18]<<F as [Future][8]>::[Output][19]>
...
Maps this future’s [`Error`][82] to a new error type using the [`Into`][46] trait. Read more
...
Maps this future’s [`Ok`][83] to a new type using the [`Into`][46] trait.
...
Unwraps this future’s output, producing a future with this future’s [`Ok`][83] type as its [`Output`][84] type. Read more
...
Wraps a [`TryFuture`] into a type that implements [`Future`][8]. Read more

§

#### fn try_poll_unpin( &mut self, cx: &mut [Context][17]<'_>, ) -> [Poll][18]<[Result][12]<Self::Ok, Self::Error>>
...
#### type [Error][88] = <U as [TryFrom][75]<T>>::[Error][81]

The type returned in the event of a conversion error.

[Source][89]§

#### fn [try_into][90](self) -> [Result][12]<U, <U as [TryFrom][75]<T>>::[Error][81]>
...
Attaches the current [default][92] [`Subscriber`][91] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/route.rs.html#108-117
   [6]: ../struct.Route.html (struct axum::routing::Route)
   [7]: ../../../src/axum/routing/route.rs.html#143-180
   [8]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html (trait core::future::future::Future)
   [9]: struct.RouteFuture.html (struct axum::routing::future::RouteFuture)
   [10]: ../../../src/axum/routing/route.rs.html#144
   [11]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output
   [12]: https://doc.rust-lang.org/nightly/core/result/enum.Result.html (enum core::result::Result)
   [13]: ../../body/struct.Body.html (struct axum::body::Body)
   [14]: ../../../src/axum/routing/route.rs.html#147-179
   ...
   [81]: https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error (type core::convert::TryFrom::Error)
   [82]: TryFuture::Error
   [83]: TryFuture::Ok
   [84]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output (associated type core::future::future::Future::Output)
