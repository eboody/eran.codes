<!-- Generated from rustdoc HTML: routing/future/struct.InfallibleRouteFuture.html -->
...
# Struct InfallibleRouteFuture Copy item path
...
### impl [Future][9] for [InfallibleRouteFuture][10]
...
### impl<'__pin> [Unpin][20] for [InfallibleRouteFuture][10]
...
### impl ![Freeze][21] for [InfallibleRouteFuture][10]

§

### impl ![RefUnwindSafe][22] for [InfallibleRouteFuture][10]

§

### impl [Send][23] for [InfallibleRouteFuture][10]

§

### impl ![Sync][24] for [InfallibleRouteFuture][10]

§

### impl ![UnwindSafe][25] for [InfallibleRouteFuture][10]
...
Attaches the current [default][90] [`Subscriber`][89] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/route.rs.html#214-220
   ...
   [8]: ../../../src/axum/routing/route.rs.html#228-237
   [9]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html (trait core::future::future::Future)
   [10]: struct.InfallibleRouteFuture.html (struct axum::routing::future::InfallibleRouteFuture)
   [11]: ../../../src/axum/routing/route.rs.html#229
   ...
   [14]: ../../../src/axum/routing/route.rs.html#231-236
