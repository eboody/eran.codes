<!-- Generated from rustdoc HTML: routing/method_routing/fn.trace_service.html -->
...
# Function trace_service Copy item path

[Source][5]
``` 
pub fn trace_service<T, S>(svc: T) -> [MethodRouter][6]<S, T::Error>
...
See [`get_service`][12] for an example.
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/method_routing.rs.html#343
