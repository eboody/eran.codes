<!-- Generated from rustdoc HTML: routing/method_routing/fn.options.html -->
...
# Function options Copy item path

[Source][5]
``` 
pub fn options<H, T, S>(handler: H) -> [MethodRouter][6]<S, [Infallible][7]>
...
See [`get`][12] for an example.
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/method_routing.rs.html#443
