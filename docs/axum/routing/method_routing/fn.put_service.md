<!-- Generated from rustdoc HTML: routing/method_routing/fn.put_service.html -->
...
# Function put_service Copy item path

[Source][5]
``` 
pub fn put_service<T, S>(svc: T) -> [MethodRouter][6]<S, T::Error>
...
See [`get_service`][12] for an example.
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/method_routing.rs.html#342
