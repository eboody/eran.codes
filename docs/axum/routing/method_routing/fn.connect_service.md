<!-- Generated from rustdoc HTML: routing/method_routing/fn.connect_service.html -->
...
# Function connect_service Copy item path

[Source][5]
``` 
pub fn connect_service<T, S>(svc: T) -> [MethodRouter][6]<S, T::Error>
...
See [`MethodFilter::CONNECT`][12] for when you’d want to use this, and [`get_service`][13] for an example.

   [1]: ../../../axum/index.html
   [2]: index.html
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/routing/method_routing.rs.html#335
   ...
   [12]: ../struct.MethodFilter.html#associatedconstant.CONNECT (associated constant axum::routing::MethodFilter::CONNECT)
   [13]: fn.get_service.html (fn axum::routing::method_routing::get_service)
