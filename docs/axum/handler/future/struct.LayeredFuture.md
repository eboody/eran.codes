<!-- Generated from rustdoc HTML: handler/future/struct.LayeredFuture.html -->
...
# Struct LayeredFuture Copy item path
...
The response future for [`Layered`][7].

## Trait Implementations§

[Source][8]§

### impl<S> [Future][9] for [LayeredFuture][10]<S>

where S: Service<[Request][6]>,

[Source][11]§

#### type [Output][12] = Response<[Body][13]>
...
### impl<'__pin, S> [Unpin][20] for [LayeredFuture][10]<S>

where PinnedFieldsOf<__Origin<'__pin, S>>: [Unpin][20], S: Service<[Request][6]>,

## Auto Trait Implementations§

§

### impl<S> ![Freeze][21] for [LayeredFuture][10]<S>

§

### impl<S> ![RefUnwindSafe][22] for [LayeredFuture][10]<S>

§

### impl<S> [Send][23] for [LayeredFuture][10]<S>

where S: [Send][23], <S as Service<Request<[Body][13]>>>::Future: [Send][23],

§

### impl<S> ![Sync][24] for [LayeredFuture][10]<S>

§

### impl<S> ![UnwindSafe][25] for [LayeredFuture][10]<S>
...
where F: [FnOnce][45](Self::[Output][19]) -> Fut, Fut: [Future][9], Self: [Sized][28],
...
where B: [Future][9]<Output = Self::[Output][19]>, Self: [Sized][28],
...
where A: [Future][9]<Output = Self::[Output][19]>, Self: [Sized][28],
...
where Self::[Output][19]: [Future][9], Self: [Sized][28],
...
#### fn boxed<'a>(self) -> [Pin][16]<[Box][48]<dyn [Future][9]<Output = Self::[Output][19]> \+ [Send][23] \+ 'a>>
...
#### fn boxed_local<'a>(self) -> [Pin][16]<[Box][48]<dyn [Future][9]<Output = Self::[Output][19]> \+ 'a>>
...
Turns a [`Future<Output = T>`][9] into a [`TryFuture<Ok = T, Error = ()`>][49].
...
Turns a [`Future<Output = T>`][9] into a [`TryFuture<Ok = T, Error = Never`>][49].
...
#### type [Output][59] = <F as [Future][9]>::[Output][19]
...
Attaches the current [default][90] [`Subscriber`][89] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/handler/future.rs.html#20-29
   [6]: ../../extract/type.Request.html (type axum::extract::Request)
   [7]: ../struct.Layered.html (struct axum::handler::Layered)
   [8]: ../../../src/axum/handler/future.rs.html#42-52
   [9]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html (trait core::future::future::Future)
   [10]: struct.LayeredFuture.html (struct axum::handler::future::LayeredFuture)
   [11]: ../../../src/axum/handler/future.rs.html#46
   [12]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output
   [13]: ../../body/struct.Body.html (struct axum::body::Body)
   [14]: ../../../src/axum/handler/future.rs.html#49-51
