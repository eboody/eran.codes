<!-- Generated from rustdoc HTML: extract/struct.Multipart.html -->
...
⚠️ Since extracting multipart form data from the request requires consuming the body, the `Multipart` extractor must be _last_ if there are multiple extractors in a handler. See [“the order of extractors”][5]
...
For security reasons, by default, `Multipart` limits the request body size to 2MB. See [`DefaultBodyLimit`][6] for how to configure this limit.
...
#### pub async fn next_field(&mut self) -> [Result][10]<[Option][11]<[Field][12]<'_>>, [MultipartError][13]>

Yields the next [`Field`][12] if available.

## Trait Implementations§

[Source][14]§

### impl [Debug][15] for [Multipart][8]
...
### impl<S> [FromRequest][20]<S> for [Multipart][8]

where S: [Send][21] \+ [Sync][22],

[Source][23]§

#### type [Rejection][24] = [MultipartRejection][25]

If the extractor fails it’ll use this “rejection” type. A rejection is a kind of error that can be converted into a response.

[Source][26]§

#### async fn [from_request][27](req: [Request][28], _state: [&S][29]) -> [Result][10]<Self, Self::[Rejection][30]>

Perform the extraction.

[Source][31]§

### impl<S> [OptionalFromRequest][32]<S> for [Multipart][8]

where S: [Send][21] \+ [Sync][22],

[Source][33]§

#### type [Rejection][34] = [MultipartRejection][25]

If the extractor fails, it will use this “rejection” type. [Read more][34]

[Source][35]§

#### async fn [from_request][36]( req: [Request][28], _state: [&S][29], ) -> [Result][10]<[Option][11]<Self>, Self::[Rejection][37]>
...
### impl [Freeze][38] for [Multipart][8]

§

### impl ![RefUnwindSafe][39] for [Multipart][8]

§

### impl [Send][21] for [Multipart][8]

§

### impl [Sync][22] for [Multipart][8]

§

### impl [Unpin][40] for [Multipart][8]

§

### impl ![UnwindSafe][41] for [Multipart][8]
...
#### fn [borrow_mut][55](&mut self) -> [&mut T][29]
...
#### fn [try_from][81](value: U) -> [Result][10]<T, <T as [TryFrom][76]<U>>::[Error][82]>
...
#### fn [try_into][88](self) -> [Result][10]<U, <U as [TryFrom][76]<T>>::[Error][82]>
...
Attaches the current [default][90] [`Subscriber`][89] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: ../../src/axum/extract/multipart.rs.html#64-66
   [5]: index.html#the-order-of-extractors (mod axum::extract)
   [6]: struct.DefaultBodyLimit.html (struct axum::extract::DefaultBodyLimit)
   [7]: ../../src/axum/extract/multipart.rs.html#106-124
   [8]: struct.Multipart.html (struct axum::extract::Multipart)
   [9]: ../../src/axum/extract/multipart.rs.html#108-123
   [10]: https://doc.rust-lang.org/nightly/core/result/enum.Result.html (enum core::result::Result)
   [11]: https://doc.rust-lang.org/nightly/core/option/enum.Option.html (enum core::option::Option)
   [12]: multipart/struct.Field.html (struct axum::extract::multipart::Field)
   [13]: multipart/struct.MultipartError.html (struct axum::extract::multipart::MultipartError)
   [14]: ../../src/axum/extract/multipart.rs.html#63
   ...
   [19]: ../../src/axum/extract/multipart.rs.html#68-82
   [20]: trait.FromRequest.html (trait axum::extract::FromRequest)
   ...
   [23]: ../../src/axum/extract/multipart.rs.html#72
   [24]: trait.FromRequest.html#associatedtype.Rejection
   [25]: multipart/enum.MultipartRejection.html (enum axum::extract::multipart::MultipartRejection)
   [26]: ../../src/axum/extract/multipart.rs.html#74-81
   [27]: trait.FromRequest.html#tymethod.from_request
   [28]: type.Request.html (type axum::extract::Request)
   [29]: https://doc.rust-lang.org/nightly/std/primitive.reference.html
   [30]: trait.FromRequest.html#associatedtype.Rejection (type axum::extract::FromRequest::Rejection)
   [31]: ../../src/axum/extract/multipart.rs.html#84-104
   [32]: trait.OptionalFromRequest.html (trait axum::extract::OptionalFromRequest)
   [33]: ../../src/axum/extract/multipart.rs.html#88
   [34]: trait.OptionalFromRequest.html#associatedtype.Rejection
   [35]: ../../src/axum/extract/multipart.rs.html#90-103
   [36]: trait.OptionalFromRequest.html#tymethod.from_request
   [37]: trait.OptionalFromRequest.html#associatedtype.Rejection (type axum::extract::OptionalFromRequest::Rejection)
