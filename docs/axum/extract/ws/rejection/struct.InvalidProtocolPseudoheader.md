<!-- Generated from rustdoc HTML: extract/ws/rejection/struct.InvalidProtocolPseudoheader.html -->
...
# Struct InvalidProtocolPseudoheader Copy item path
...
### impl [InvalidProtocolPseudoheader][8]
...
### impl [Debug][10] for [InvalidProtocolPseudoheader][8]
...
### impl [Default][14] for [InvalidProtocolPseudoheader][8]
...
### impl [Display][16] for [InvalidProtocolPseudoheader][8]
...
### impl [Error][18] for [InvalidProtocolPseudoheader][8]
...
### impl [From][31]<[InvalidProtocolPseudoheader][8]> for [WebSocketUpgradeRejection][32]

[Source][30]§

#### fn [from][33](inner: [InvalidProtocolPseudoheader][8]) -> Self

Converts to this type from the input type.

[Source][6]§

### impl [IntoResponse][34] for [InvalidProtocolPseudoheader][8]
...
### impl [Freeze][37] for [InvalidProtocolPseudoheader][8]

§

### impl [RefUnwindSafe][38] for [InvalidProtocolPseudoheader][8]

§

### impl [Send][39] for [InvalidProtocolPseudoheader][8]

§

### impl [Sync][40] for [InvalidProtocolPseudoheader][8]

§

### impl [Unpin][41] for [InvalidProtocolPseudoheader][8]

§

### impl [UnwindSafe][42] for [InvalidProtocolPseudoheader][8]
...
Attaches the current [default][97] [`Subscriber`][96] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [4]: ../../index.html
   [5]: ../index.html
   [6]: ../../../../src/axum/extract/ws.rs.html#975-980
   [7]: ../../struct.WebSocketUpgrade.html (struct axum::extract::WebSocketUpgrade)
   [8]: struct.InvalidProtocolPseudoheader.html (struct axum::extract::ws::rejection::InvalidProtocolPseudoheader)
