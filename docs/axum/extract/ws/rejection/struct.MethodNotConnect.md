<!-- Generated from rustdoc HTML: extract/ws/rejection/struct.MethodNotConnect.html -->
...
# Struct MethodNotConnect Copy item path
...
### impl [Debug][10] for [MethodNotConnect][8]
...
### impl [Default][14] for [MethodNotConnect][8]
...
### impl [Display][16] for [MethodNotConnect][8]
...
### impl [Error][18] for [MethodNotConnect][8]
...
### impl [From][31]<[MethodNotConnect][8]> for [WebSocketUpgradeRejection][32]

[Source][30]§

#### fn [from][33](inner: [MethodNotConnect][8]) -> Self

Converts to this type from the input type.

[Source][6]§

### impl [IntoResponse][34] for [MethodNotConnect][8]
...
### impl [Freeze][37] for [MethodNotConnect][8]

§

### impl [RefUnwindSafe][38] for [MethodNotConnect][8]

§

### impl [Send][39] for [MethodNotConnect][8]

§

### impl [Sync][40] for [MethodNotConnect][8]

§

### impl [Unpin][41] for [MethodNotConnect][8]

§

### impl [UnwindSafe][42] for [MethodNotConnect][8]
...
Attaches the current [default][97] [`Subscriber`][96] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [4]: ../../index.html
   [5]: ../index.html
   [6]: ../../../../src/axum/extract/ws.rs.html#954-959
