<!-- Generated from rustdoc HTML: extract/ws/rejection/struct.InvalidConnectionHeader.html -->
...
# Struct InvalidConnectionHeader Copy item path
...
### impl [InvalidConnectionHeader][8]
...
### impl [Debug][10] for [InvalidConnectionHeader][8]
...
### impl [Default][14] for [InvalidConnectionHeader][8]
...
### impl [Display][16] for [InvalidConnectionHeader][8]
...
### impl [Error][18] for [InvalidConnectionHeader][8]
...
### impl [From][31]<[InvalidConnectionHeader][8]> for [WebSocketUpgradeRejection][32]

[Source][30]§

#### fn [from][33](inner: [InvalidConnectionHeader][8]) -> Self

Converts to this type from the input type.

[Source][6]§

### impl [IntoResponse][34] for [InvalidConnectionHeader][8]
...
### impl [Freeze][37] for [InvalidConnectionHeader][8]

§

### impl [RefUnwindSafe][38] for [InvalidConnectionHeader][8]

§

### impl [Send][39] for [InvalidConnectionHeader][8]

§

### impl [Sync][40] for [InvalidConnectionHeader][8]

§

### impl [Unpin][41] for [InvalidConnectionHeader][8]

§

### impl [UnwindSafe][42] for [InvalidConnectionHeader][8]
...
Attaches the current [default][97] [`Subscriber`][96] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [4]: ../../index.html
   [5]: ../index.html
   [6]: ../../../../src/axum/extract/ws.rs.html#961-966
