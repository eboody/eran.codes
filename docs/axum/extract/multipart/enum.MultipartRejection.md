<!-- Generated from rustdoc HTML: extract/multipart/enum.MultipartRejection.html -->
...
# Enum MultipartRejection Copy item path
...
pub enum MultipartRejection {
    InvalidBoundary([InvalidBoundary][6]),
}
```
...
Rejection used for [`Multipart`][7].

Contains one variant for each way the [`Multipart`][7] extractor can fail.
...
### impl [Debug][10] for [MultipartRejection][8]
...
### impl [Display][14] for [MultipartRejection][8]
...
### impl [Error][16] for [MultipartRejection][8]
...
### impl [From][27]<[InvalidBoundary][6]> for [MultipartRejection][8]

[Source][5]§

#### fn [from][28](inner: [InvalidBoundary][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][29] for [MultipartRejection][8]
...
### impl [Freeze][32] for [MultipartRejection][8]

§

### impl [RefUnwindSafe][33] for [MultipartRejection][8]

§

### impl [Send][34] for [MultipartRejection][8]

§

### impl [Sync][35] for [MultipartRejection][8]

§

### impl [Unpin][36] for [MultipartRejection][8]

§

### impl [UnwindSafe][37] for [MultipartRejection][8]
...
Attaches the current [default][92] [`Subscriber`][91] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/multipart.rs.html#340-347
   [6]: struct.InvalidBoundary.html (struct axum::extract::multipart::InvalidBoundary)
   [7]: ../struct.Multipart.html (struct axum::extract::Multipart)
   [8]: enum.MultipartRejection.html (enum axum::extract::multipart::MultipartRejection)
