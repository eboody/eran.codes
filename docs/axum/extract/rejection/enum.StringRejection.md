<!-- Generated from rustdoc HTML: extract/rejection/enum.StringRejection.html -->
...
# Enum StringRejection Copy item path
```
#[non_exhaustive]

pub enum StringRejection {
    FailedToBufferBody([FailedToBufferBody][5]),
    InvalidUtf8([InvalidUtf8][6]),
}
```

Expand description

Rejection used for [`String`][7].

Contains one variant for each way the [`String`][7] extractor can fail.
...
### impl [Debug][9] for [StringRejection][8]
...
### impl [Display][15] for [StringRejection][8]
...
### impl [Error][17] for [StringRejection][8]
...
### impl [From][28]<[FailedToBufferBody][5]> for [StringRejection][8]

§

#### fn [from][29](inner: [FailedToBufferBody][5]) -> [StringRejection][8]

Converts to this type from the input type.

§

### impl [From][28]<[InvalidUtf8][6]> for [StringRejection][8]

§

#### fn [from][29](inner: [InvalidUtf8][6]) -> [StringRejection][8]

Converts to this type from the input type.

§

### impl [IntoResponse][30] for [StringRejection][8]

§

#### fn [into_response][31](self) -> Response<[Body][32]>
...
### impl [Freeze][33] for [StringRejection][8]

§

### impl ![RefUnwindSafe][34] for [StringRejection][8]

§

### impl [Send][35] for [StringRejection][8]

§

### impl [Sync][36] for [StringRejection][8]

§

### impl [Unpin][37] for [StringRejection][8]

§

### impl ![UnwindSafe][38] for [StringRejection][8]
...
#### fn try_to_string(&self) -> [Result][12]<[String][7], [TryReserveError][75]>
...
#### fn [try_from][83](value: U) -> [Result][12]<T, <T as [TryFrom][78]<U>>::[Error][84]>
...
#### fn [try_into][90](self) -> [Result][12]<U, <U as [TryFrom][78]<T>>::[Error][84]>
...
Attaches the current [default][92] [`Subscriber`][91] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [8]: enum.StringRejection.html (enum axum::extract::rejection::StringRejection)
