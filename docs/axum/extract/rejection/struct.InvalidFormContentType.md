<!-- Generated from rustdoc HTML: extract/rejection/struct.InvalidFormContentType.html -->
...
# Struct InvalidFormContentType Copy item path
...
Rejection type for [`Form`][6] or [`RawForm`][7] used if the `Content-Type` header is missing or its value is not `application/x-www-form-urlencoded`.

## Implementations§

[Source][5]§

### impl [InvalidFormContentType][8]
...
### impl [Debug][10] for [InvalidFormContentType][8]
...
### impl [Default][14] for [InvalidFormContentType][8]
...
### impl [Display][16] for [InvalidFormContentType][8]
...
### impl [Error][18] for [InvalidFormContentType][8]
...
### impl [From][31]<[InvalidFormContentType][8]> for [FormRejection][32]

[Source][30]§

#### fn [from][33](inner: [InvalidFormContentType][8]) -> Self

Converts to this type from the input type.

[Source][34]§

### impl [From][31]<[InvalidFormContentType][8]> for [RawFormRejection][35]
...
### impl [IntoResponse][36] for [InvalidFormContentType][8]

[Source][5]§

#### fn [into_response][37](self) -> [Response][38]
...
### impl [Freeze][39] for [InvalidFormContentType][8]

§

### impl [RefUnwindSafe][40] for [InvalidFormContentType][8]

§

### impl [Send][41] for [InvalidFormContentType][8]

§

### impl [Sync][42] for [InvalidFormContentType][8]

§

### impl [Unpin][43] for [InvalidFormContentType][8]

§

### impl [UnwindSafe][44] for [InvalidFormContentType][8]
...
where T: [Display][16] \+ ?[Sized][47],

[Source][79]§

#### fn [to_string][80](&self) -> [String][9]
...
#### fn try_to_string(&self) -> [Result][81]<[String][9], [TryReserveError][82]>

[`ToString::to_string`][83], but without panic on OOM.
...
#### fn [try_from][90](value: U) -> [Result][81]<T, <T as [TryFrom][85]<U>>::[Error][91]>
...
#### fn [try_into][97](self) -> [Result][81]<U, <U as [TryFrom][85]<T>>::[Error][91]>
...
Attaches the current [default][99] [`Subscriber`][98] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#59-66
   [6]: ../../struct.Form.html (struct axum::Form)
   [7]: ../struct.RawForm.html (struct axum::extract::RawForm)
   [8]: struct.InvalidFormContentType.html (struct axum::extract::rejection::InvalidFormContentType)
   ...
   [30]: ../../../src/axum/extract/rejection.rs.html#102-113
   ...
   [38]: ../../response/type.Response.html (type axum::response::Response)
   ...
   [82]: https://doc.rust-lang.org/nightly/alloc/collections/struct.TryReserveError.html (struct alloc::collections::TryReserveError)
   [83]: https://doc.rust-lang.org/nightly/alloc/string/trait.ToString.html#tymethod.to_string (method alloc::string::ToString::to_string)
   [84]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#827-829
   [85]: https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html (trait core::convert::TryFrom)
   [86]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#831
   [87]: https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error
   [88]: https://doc.rust-lang.org/nightly/core/convert/enum.Infallible.html (enum core::convert::Infallible)
   [89]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#834
   [90]: https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#tymethod.try_from
   [91]: https://doc.rust-lang.org/nightly/core/convert/trait.TryFrom.html#associatedtype.Error (type core::convert::TryFrom::Error)
   [92]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#811-813
   [93]: https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html (trait core::convert::TryInto)
   [94]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#815
   [95]: https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html#associatedtype.Error
   [96]: https://doc.rust-lang.org/nightly/src/core/convert/mod.rs.html#818
   [97]: https://doc.rust-lang.org/nightly/core/convert/trait.TryInto.html#tymethod.try_into
   [98]: super::Subscriber
