<!-- Generated from rustdoc HTML: extract/rejection/enum.ExtensionRejection.html -->
...
# Enum ExtensionRejection Copy item path
...
pub enum ExtensionRejection {
    MissingExtension([MissingExtension][6]),
}
```

Expand description

Rejection used for [`Extension`][7].

Contains one variant for each way the [`Extension`][7] extractor can fail.
...
### impl [Debug][10] for [ExtensionRejection][8]
...
### impl [Display][14] for [ExtensionRejection][8]
...
### impl [Error][16] for [ExtensionRejection][8]
...
### impl [From][27]<[MissingExtension][6]> for [ExtensionRejection][8]

[Source][5]§

#### fn [from][28](inner: [MissingExtension][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][29] for [ExtensionRejection][8]
...
### impl [Freeze][32] for [ExtensionRejection][8]

§

### impl ![RefUnwindSafe][33] for [ExtensionRejection][8]

§

### impl [Send][34] for [ExtensionRejection][8]

§

### impl [Sync][35] for [ExtensionRejection][8]

§

### impl [Unpin][36] for [ExtensionRejection][8]

§

### impl ![UnwindSafe][37] for [ExtensionRejection][8]
...
Attaches the current [default][92] [`Subscriber`][91] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#141-149
   [6]: struct.MissingExtension.html (struct axum::extract::rejection::MissingExtension)
   [7]: ../../struct.Extension.html (struct axum::Extension)
   [8]: enum.ExtensionRejection.html (enum axum::extract::rejection::ExtensionRejection)
