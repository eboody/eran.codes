<!-- Generated from rustdoc HTML: extract/rejection/struct.FailedToDeserializeFormBody.html -->
...
# Struct FailedToDeserializeFormBody Copy item path

[Source][5]
``` 
pub struct FailedToDeserializeFormBody(/* private fields */);
```

Expand description

Rejection type used if the [`Form`][6] extractor is unable to deserialize the form body into the target type.

## Implementations§

[Source][5]§

### impl [FailedToDeserializeFormBody][7]
...
### impl [Debug][9] for [FailedToDeserializeFormBody][7]
...
### impl [Display][13] for [FailedToDeserializeFormBody][7]
...
### impl [Error][15] for [FailedToDeserializeFormBody][7]
...
### impl [From][27]<[FailedToDeserializeFormBody][7]> for [FormRejection][28]

[Source][26]§

#### fn [from][29](inner: [FailedToDeserializeFormBody][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [FailedToDeserializeFormBody][7]
...
### impl [Freeze][33] for [FailedToDeserializeFormBody][7]

§

### impl ![RefUnwindSafe][34] for [FailedToDeserializeFormBody][7]

§

### impl [Send][35] for [FailedToDeserializeFormBody][7]

§

### impl [Sync][36] for [FailedToDeserializeFormBody][7]

§

### impl [Unpin][37] for [FailedToDeserializeFormBody][7]

§

### impl ![UnwindSafe][38] for [FailedToDeserializeFormBody][7]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#76-82
   [6]: ../../struct.Form.html (struct axum::Form)
   [7]: struct.FailedToDeserializeFormBody.html (struct axum::extract::rejection::FailedToDeserializeFormBody)
   ...
   [26]: ../../../src/axum/extract/rejection.rs.html#102-113
   [27]: https://doc.rust-lang.org/nightly/core/convert/trait.From.html (trait core::convert::From)
   [28]: enum.FormRejection.html (enum axum::extract::rejection::FormRejection)
