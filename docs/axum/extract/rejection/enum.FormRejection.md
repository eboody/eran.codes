<!-- Generated from rustdoc HTML: extract/rejection/enum.FormRejection.html -->
...
### Trait Implementations
  ...
  * Error
  * From<BytesRejection>
  * From<FailedToDeserializeForm>
  * From<FailedToDeserializeFormBody>
...
# Enum FormRejection Copy item path
...
pub enum FormRejection {
    InvalidFormContentType([InvalidFormContentType][6]),
    FailedToDeserializeForm([FailedToDeserializeForm][7]),
    FailedToDeserializeFormBody([FailedToDeserializeFormBody][8]),
    BytesRejection([BytesRejection][9]),
}
```

Expand description

Rejection used for [`Form`][10].

Contains one variant for each way the [`Form`][10] extractor can fail.
...
### impl [FormRejection][11]

[Source][5]

#### pub fn body_text(&self) -> [String][12]
...
### impl [Debug][13] for [FormRejection][11]
...
### impl [Display][17] for [FormRejection][11]

[Source][5]§

#### fn [fmt][18](&self, f: &mut [Formatter][15]<'_>) -> [Result][16]

Formats the value using the given formatter. [Read more][18]

[Source][5]§

### impl [Error][19] for [FormRejection][11]

[Source][5]§

#### fn [source][20](&self) -> [Option][21]<&(dyn [Error][19] \+ 'static)>
...
#### fn [cause][26](&self) -> [Option][21]<&dyn [Error][19]>
...
### impl [From][30]<[BytesRejection][9]> for [FormRejection][11]

[Source][5]§

#### fn [from][31](inner: [BytesRejection][9]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][30]<[FailedToDeserializeForm][7]> for [FormRejection][11]

[Source][5]§

#### fn [from][31](inner: [FailedToDeserializeForm][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][30]<[FailedToDeserializeFormBody][8]> for [FormRejection][11]

[Source][5]§

#### fn [from][31](inner: [FailedToDeserializeFormBody][8]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][30]<[InvalidFormContentType][6]> for [FormRejection][11]

[Source][5]§

#### fn [from][31](inner: [InvalidFormContentType][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][32] for [FormRejection][11]
...
### impl [Freeze][35] for [FormRejection][11]

§

### impl ![RefUnwindSafe][36] for [FormRejection][11]

§

### impl [Send][37] for [FormRejection][11]

§

### impl [Sync][38] for [FormRejection][11]

§

### impl [Unpin][39] for [FormRejection][11]

§

### impl ![UnwindSafe][40] for [FormRejection][11]
...
where T: [Display][17] \+ ?[Sized][43],

[Source][75]§

#### fn [to_string][76](&self) -> [String][12]
...
#### fn try_to_string(&self) -> [Result][77]<[String][12], [TryReserveError][78]>
...
Attaches the current [default][95] [`Subscriber`][94] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#102-113
   [6]: struct.InvalidFormContentType.html (struct axum::extract::rejection::InvalidFormContentType)
   [7]: struct.FailedToDeserializeForm.html (struct axum::extract::rejection::FailedToDeserializeForm)
   [8]: struct.FailedToDeserializeFormBody.html (struct axum::extract::rejection::FailedToDeserializeFormBody)
   [9]: enum.BytesRejection.html (enum axum::extract::rejection::BytesRejection)
   [10]: ../../struct.Form.html (struct axum::Form)
   [11]: enum.FormRejection.html (enum axum::extract::rejection::FormRejection)
