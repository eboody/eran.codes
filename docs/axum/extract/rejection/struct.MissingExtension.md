<!-- Generated from rustdoc HTML: extract/rejection/struct.MissingExtension.html -->
...
# Struct MissingExtension Copy item path
...
Rejection type for [`Extension`][6] if an expected request extension was not found.

## Implementations§

[Source][5]§

### impl [MissingExtension][7]
...
### impl [Debug][9] for [MissingExtension][7]
...
### impl [Display][13] for [MissingExtension][7]
...
### impl [Error][15] for [MissingExtension][7]
...
### impl [From][27]<[MissingExtension][7]> for [ExtensionRejection][28]

[Source][26]§

#### fn [from][29](inner: [MissingExtension][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [MissingExtension][7]
...
### impl [Freeze][33] for [MissingExtension][7]

§

### impl ![RefUnwindSafe][34] for [MissingExtension][7]

§

### impl [Send][35] for [MissingExtension][7]

§

### impl [Sync][36] for [MissingExtension][7]

§

### impl [Unpin][37] for [MissingExtension][7]

§

### impl ![UnwindSafe][38] for [MissingExtension][7]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#42-48
   [6]: ../../struct.Extension.html (struct axum::Extension)
   [7]: struct.MissingExtension.html (struct axum::extract::rejection::MissingExtension)
   ...
   [26]: ../../../src/axum/extract/rejection.rs.html#141-149
   [27]: https://doc.rust-lang.org/nightly/core/convert/trait.From.html (trait core::convert::From)
   [28]: enum.ExtensionRejection.html (enum axum::extract::rejection::ExtensionRejection)
