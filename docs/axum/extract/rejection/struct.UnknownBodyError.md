<!-- Generated from rustdoc HTML: extract/rejection/struct.UnknownBodyError.html -->
...
# Struct UnknownBodyError Copy item path
```
pub struct UnknownBodyError(/* private fields */);
```
...
### impl [Debug][7] for [UnknownBodyError][5]
...
### impl [Display][13] for [UnknownBodyError][5]
...
### impl [Error][15] for [UnknownBodyError][5]
...
### impl [From][26]<[UnknownBodyError][5]> for [FailedToBufferBody][27]

§

#### fn [from][28](inner: [UnknownBodyError][5]) -> [FailedToBufferBody][27]

Converts to this type from the input type.

§

### impl [IntoResponse][29] for [UnknownBodyError][5]
...
### impl [Freeze][32] for [UnknownBodyError][5]

§

### impl ![RefUnwindSafe][33] for [UnknownBodyError][5]

§

### impl [Send][34] for [UnknownBodyError][5]

§

### impl [Sync][35] for [UnknownBodyError][5]

§

### impl [Unpin][36] for [UnknownBodyError][5]

§

### impl ![UnwindSafe][37] for [UnknownBodyError][5]
...
Attaches the current [default][91] [`Subscriber`][90] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: struct.UnknownBodyError.html (struct axum::extract::rejection::UnknownBodyError)
