<!-- Generated from rustdoc HTML: extract/rejection/struct.JsonDataError.html -->
...
# Struct JsonDataError Copy item path

[Source][5]
``` 
pub struct JsonDataError(/* private fields */);
```
...
### impl [Debug][9] for [JsonDataError][7]
...
### impl [Display][13] for [JsonDataError][7]
...
### impl [Error][15] for [JsonDataError][7]
...
### impl [From][27]<[JsonDataError][7]> for [JsonRejection][28]

[Source][26]§

#### fn [from][29](inner: [JsonDataError][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [JsonDataError][7]
...
### impl [Freeze][33] for [JsonDataError][7]

§

### impl ![RefUnwindSafe][34] for [JsonDataError][7]

§

### impl [Send][35] for [JsonDataError][7]

§

### impl [Sync][36] for [JsonDataError][7]

§

### impl [Unpin][37] for [JsonDataError][7]

§

### impl ![UnwindSafe][38] for [JsonDataError][7]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#10-19
   [6]: ../../struct.Json.html (struct axum::Json)
   [7]: struct.JsonDataError.html (struct axum::extract::rejection::JsonDataError)
