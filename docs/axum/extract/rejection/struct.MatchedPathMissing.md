<!-- Generated from rustdoc HTML: extract/rejection/struct.MatchedPathMissing.html -->
...
# Struct MatchedPathMissing Copy item path
...
See [`MatchedPath`][6] for more details.

## Implementations§

[Source][5]§

### impl [MatchedPathMissing][7]
...
### impl [Debug][9] for [MatchedPathMissing][7]
...
### impl [Default][13] for [MatchedPathMissing][7]
...
### impl [Display][15] for [MatchedPathMissing][7]
...
### impl [Error][17] for [MatchedPathMissing][7]
...
### impl [From][30]<[MatchedPathMissing][7]> for [MatchedPathRejection][31]

[Source][29]§

#### fn [from][32](inner: [MatchedPathMissing][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][33] for [MatchedPathMissing][7]
...
### impl [Freeze][36] for [MatchedPathMissing][7]

§

### impl [RefUnwindSafe][37] for [MatchedPathMissing][7]

§

### impl [Send][38] for [MatchedPathMissing][7]

§

### impl [Sync][39] for [MatchedPathMissing][7]

§

### impl [Unpin][40] for [MatchedPathMissing][7]

§

### impl [UnwindSafe][41] for [MatchedPathMissing][7]
...
Attaches the current [default][96] [`Subscriber`][95] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#174-182
   [6]: ../struct.MatchedPath.html (struct axum::extract::MatchedPath)
   [7]: struct.MatchedPathMissing.html (struct axum::extract::rejection::MatchedPathMissing)
   ...
   [29]: ../../../src/axum/extract/rejection.rs.html#185-191
   [30]: https://doc.rust-lang.org/nightly/core/convert/trait.From.html (trait core::convert::From)
   [31]: enum.MatchedPathRejection.html (enum axum::extract::rejection::MatchedPathRejection)
