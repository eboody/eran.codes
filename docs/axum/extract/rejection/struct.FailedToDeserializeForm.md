<!-- Generated from rustdoc HTML: extract/rejection/struct.FailedToDeserializeForm.html -->
...
# Struct FailedToDeserializeForm Copy item path

[Source][5]
``` 
pub struct FailedToDeserializeForm(/* private fields */);
```

Expand description

Rejection type used if the [`Form`][6] extractor is unable to deserialize the form into the target type.

## Implementations§

[Source][5]§

### impl [FailedToDeserializeForm][7]
...
### impl [Debug][9] for [FailedToDeserializeForm][7]
...
### impl [Display][13] for [FailedToDeserializeForm][7]
...
### impl [Error][15] for [FailedToDeserializeForm][7]
...
### impl [From][27]<[FailedToDeserializeForm][7]> for [FormRejection][28]

[Source][26]§

#### fn [from][29](inner: [FailedToDeserializeForm][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [FailedToDeserializeForm][7]
...
### impl [Freeze][33] for [FailedToDeserializeForm][7]

§

### impl ![RefUnwindSafe][34] for [FailedToDeserializeForm][7]

§

### impl [Send][35] for [FailedToDeserializeForm][7]

§

### impl [Sync][36] for [FailedToDeserializeForm][7]

§

### impl [Unpin][37] for [FailedToDeserializeForm][7]

§

### impl ![UnwindSafe][38] for [FailedToDeserializeForm][7]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#68-74
