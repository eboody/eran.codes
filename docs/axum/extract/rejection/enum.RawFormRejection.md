<!-- Generated from rustdoc HTML: extract/rejection/enum.RawFormRejection.html -->
...
# Enum RawFormRejection Copy item path
...
pub enum RawFormRejection {
    ...
    BytesRejection([BytesRejection][7]),
}
```

Expand description

Rejection used for [`RawForm`][8].

Contains one variant for each way the [`RawForm`][8] extractor can fail.
...
### impl [Debug][11] for [RawFormRejection][9]
...
### impl [Display][15] for [RawFormRejection][9]
...
### impl [Error][17] for [RawFormRejection][9]
...
### impl [From][28]<[BytesRejection][7]> for [RawFormRejection][9]

[Source][5]§

#### fn [from][29](inner: [BytesRejection][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][28]<[InvalidFormContentType][6]> for [RawFormRejection][9]

[Source][5]§

#### fn [from][29](inner: [InvalidFormContentType][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [RawFormRejection][9]
...
### impl [Freeze][33] for [RawFormRejection][9]

§

### impl ![RefUnwindSafe][34] for [RawFormRejection][9]

§

### impl [Send][35] for [RawFormRejection][9]

§

### impl [Sync][36] for [RawFormRejection][9]

§

### impl [Unpin][37] for [RawFormRejection][9]

§

### impl ![UnwindSafe][38] for [RawFormRejection][9]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#115-124
   ...
   [8]: ../struct.RawForm.html (struct axum::extract::RawForm)
   [9]: enum.RawFormRejection.html (enum axum::extract::rejection::RawFormRejection)
