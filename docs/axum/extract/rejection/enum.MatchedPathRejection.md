<!-- Generated from rustdoc HTML: extract/rejection/enum.MatchedPathRejection.html -->
...
# Enum MatchedPathRejection Copy item path
...
pub enum MatchedPathRejection {
    MatchedPathMissing([MatchedPathMissing][6]),
}
```
...
Rejection used for [`MatchedPath`][7].
...
### impl [Debug][10] for [MatchedPathRejection][8]
...
### impl [Display][14] for [MatchedPathRejection][8]
...
### impl [Error][16] for [MatchedPathRejection][8]
...
### impl [From][27]<[MatchedPathMissing][6]> for [MatchedPathRejection][8]

[Source][5]§

#### fn [from][28](inner: [MatchedPathMissing][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][29] for [MatchedPathRejection][8]
...
### impl [Freeze][32] for [MatchedPathRejection][8]

§

### impl [RefUnwindSafe][33] for [MatchedPathRejection][8]

§

### impl [Send][34] for [MatchedPathRejection][8]

§

### impl [Sync][35] for [MatchedPathRejection][8]

§

### impl [Unpin][36] for [MatchedPathRejection][8]

§

### impl [UnwindSafe][37] for [MatchedPathRejection][8]
...
Attaches the current [default][92] [`Subscriber`][91] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#185-191
   [6]: struct.MatchedPathMissing.html (struct axum::extract::rejection::MatchedPathMissing)
   [7]: ../struct.MatchedPath.html (struct axum::extract::MatchedPath)
   [8]: enum.MatchedPathRejection.html (enum axum::extract::rejection::MatchedPathRejection)
