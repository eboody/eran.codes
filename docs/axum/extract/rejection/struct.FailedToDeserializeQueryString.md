<!-- Generated from rustdoc HTML: extract/rejection/struct.FailedToDeserializeQueryString.html -->
...
# Struct FailedToDeserializeQueryString Copy item path

[Source][5]
``` 
pub struct FailedToDeserializeQueryString(/* private fields */);
```

Expand description

Rejection type used if the [`Query`][6] extractor is unable to deserialize the query string into the target type.

## Implementations§

[Source][5]§

### impl [FailedToDeserializeQueryString][7]
...
### impl [Debug][9] for [FailedToDeserializeQueryString][7]
...
### impl [Display][13] for [FailedToDeserializeQueryString][7]
...
### impl [Error][15] for [FailedToDeserializeQueryString][7]
...
### impl [From][27]<[FailedToDeserializeQueryString][7]> for [QueryRejection][28]

[Source][26]§

#### fn [from][29](inner: [FailedToDeserializeQueryString][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][30] for [FailedToDeserializeQueryString][7]
...
### impl [Freeze][33] for [FailedToDeserializeQueryString][7]

§

### impl ![RefUnwindSafe][34] for [FailedToDeserializeQueryString][7]

§

### impl [Send][35] for [FailedToDeserializeQueryString][7]

§

### impl [Sync][36] for [FailedToDeserializeQueryString][7]

§

### impl [Unpin][37] for [FailedToDeserializeQueryString][7]

§

### impl ![UnwindSafe][38] for [FailedToDeserializeQueryString][7]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#84-90
   [6]: ../struct.Query.html (struct axum::extract::Query)
   [7]: struct.FailedToDeserializeQueryString.html (struct axum::extract::rejection::FailedToDeserializeQueryString)
   ...
   [26]: ../../../src/axum/extract/rejection.rs.html#92-100
   [27]: https://doc.rust-lang.org/nightly/core/convert/trait.From.html (trait core::convert::From)
   [28]: enum.QueryRejection.html (enum axum::extract::rejection::QueryRejection)
