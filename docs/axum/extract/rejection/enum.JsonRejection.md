<!-- Generated from rustdoc HTML: extract/rejection/enum.JsonRejection.html -->
...
# Enum JsonRejection Copy item path
...
pub enum JsonRejection {
    JsonDataError([JsonDataError][6]),
    JsonSyntaxError([JsonSyntaxError][7]),
    MissingJsonContentType([MissingJsonContentType][8]),
...
Rejection used for [`Json`][10].

Contains one variant for each way the [`Json`][10] extractor can fail.
...
### impl [Debug][13] for [JsonRejection][11]
...
### impl [Display][17] for [JsonRejection][11]
...
### impl [Error][19] for [JsonRejection][11]
...
### impl [From][30]<[BytesRejection][9]> for [JsonRejection][11]
...
### impl [From][30]<[JsonDataError][6]> for [JsonRejection][11]

[Source][5]§

#### fn [from][31](inner: [JsonDataError][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][30]<[JsonSyntaxError][7]> for [JsonRejection][11]

[Source][5]§

#### fn [from][31](inner: [JsonSyntaxError][7]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][30]<[MissingJsonContentType][8]> for [JsonRejection][11]

[Source][5]§

#### fn [from][31](inner: [MissingJsonContentType][8]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [IntoResponse][32] for [JsonRejection][11]
...
### impl [Freeze][35] for [JsonRejection][11]

§

### impl ![RefUnwindSafe][36] for [JsonRejection][11]

§

### impl [Send][37] for [JsonRejection][11]

§

### impl [Sync][38] for [JsonRejection][11]

§

### impl [Unpin][39] for [JsonRejection][11]

§

### impl ![UnwindSafe][40] for [JsonRejection][11]
...
Attaches the current [default][95] [`Subscriber`][94] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#127-139
   [6]: struct.JsonDataError.html (struct axum::extract::rejection::JsonDataError)
   [7]: struct.JsonSyntaxError.html (struct axum::extract::rejection::JsonSyntaxError)
   [8]: struct.MissingJsonContentType.html (struct axum::extract::rejection::MissingJsonContentType)
   [9]: enum.BytesRejection.html (enum axum::extract::rejection::BytesRejection)
   [10]: ../../struct.Json.html (struct axum::Json)
   [11]: enum.JsonRejection.html (enum axum::extract::rejection::JsonRejection)
