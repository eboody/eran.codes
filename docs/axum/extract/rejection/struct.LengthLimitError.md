<!-- Generated from rustdoc HTML: extract/rejection/struct.LengthLimitError.html -->
...
# Struct LengthLimitError Copy item path
```
pub struct LengthLimitError(/* private fields */);
```
...
This can _only_ happen when you’re using [`tower_http::limit::RequestBodyLimitLayer`] or otherwise wrapping request bodies in [`http_body_util::Limited`].

## Implementations§

§

### impl [LengthLimitError][5]

#### pub fn body_text(&self) -> [String][6]
...
### impl [Debug][7] for [LengthLimitError][5]
...
### impl [Display][13] for [LengthLimitError][5]
...
### impl [Error][15] for [LengthLimitError][5]
...
### impl [From][26]<[LengthLimitError][5]> for [FailedToBufferBody][27]

§

#### fn [from][28](inner: [LengthLimitError][5]) -> [FailedToBufferBody][27]

Converts to this type from the input type.

§

### impl [IntoResponse][29] for [LengthLimitError][5]
...
### impl [Freeze][32] for [LengthLimitError][5]

§

### impl ![RefUnwindSafe][33] for [LengthLimitError][5]

§

### impl [Send][34] for [LengthLimitError][5]

§

### impl [Sync][35] for [LengthLimitError][5]

§

### impl [Unpin][36] for [LengthLimitError][5]

§

### impl ![UnwindSafe][37] for [LengthLimitError][5]
...
#### fn try_to_string(&self) -> [Result][10]<[String][6], [TryReserveError][74]>
...
Attaches the current [default][91] [`Subscriber`][90] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [27]: enum.FailedToBufferBody.html (enum axum::extract::rejection::FailedToBufferBody)
