<!-- Generated from rustdoc HTML: extract/rejection/enum.PathRejection.html -->
...
# Enum PathRejection Copy item path
...
pub enum PathRejection {
    FailedToDeserializePathParams([FailedToDeserializePathParams][6]),
...
Rejection used for [`Path`][8].

Contains one variant for each way the [`Path`][8] extractor can fail.
...
### impl [Debug][11] for [PathRejection][9]
...
### impl [Display][15] for [PathRejection][9]
...
### impl [Error][17] for [PathRejection][9]
...
### impl [From][28]<[FailedToDeserializePathParams][6]> for [PathRejection][9]

[Source][5]§

#### fn [from][29](inner: [FailedToDeserializePathParams][6]) -> Self

Converts to this type from the input type.

[Source][5]§

### impl [From][28]<[MissingPathParams][7]> for [PathRejection][9]
...
### impl [IntoResponse][30] for [PathRejection][9]
...
### impl [Freeze][33] for [PathRejection][9]

§

### impl [RefUnwindSafe][34] for [PathRejection][9]

§

### impl [Send][35] for [PathRejection][9]

§

### impl [Sync][36] for [PathRejection][9]

§

### impl [Unpin][37] for [PathRejection][9]

§

### impl [UnwindSafe][38] for [PathRejection][9]
...
Attaches the current [default][93] [`Subscriber`][92] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/rejection.rs.html#151-160
   [6]: ../path/struct.FailedToDeserializePathParams.html (struct axum::extract::path::FailedToDeserializePathParams)
   [7]: struct.MissingPathParams.html (struct axum::extract::rejection::MissingPathParams)
   [8]: ../struct.Path.html (struct axum::extract::Path)
   [9]: enum.PathRejection.html (enum axum::extract::rejection::PathRejection)
