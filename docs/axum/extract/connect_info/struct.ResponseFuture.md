<!-- Generated from rustdoc HTML: extract/connect_info/struct.ResponseFuture.html -->
...
# Struct ResponseFuture Copy item path
...
Response future for [`IntoMakeServiceWithConnectInfo`][6].

## Trait Implementations§

[Source][5]§

### impl<S, C> [Debug][7] for [ResponseFuture][8]<S, C>
...
### impl<S, C> [Future][12] for [ResponseFuture][8]<S, C>

where [Ready][13]<[Result][14]<[AddExtension][15]<S, [ConnectInfo][16]<C>>, [Infallible][17]>>: [Future][12],

[Source][5]§

#### type [Output][18] = <[Ready][13]<[Result][14]<[AddExtension][15]<S, [ConnectInfo][16]<C>>, [Infallible][17]>> as [Future][12]>::[Output][19]
...
### impl<'__pin, S, C> [Unpin][24] for [ResponseFuture][8]<S, C>

where PinnedFieldsOf<__Origin<'__pin, S, C>>: [Unpin][24],

## Auto Trait Implementations§

§

### impl<S, C> [Freeze][25] for [ResponseFuture][8]<S, C>

where S: [Freeze][25], C: [Freeze][25],

§

### impl<S, C> [RefUnwindSafe][26] for [ResponseFuture][8]<S, C>

where S: [RefUnwindSafe][26], C: [RefUnwindSafe][26],

§

### impl<S, C> [Send][27] for [ResponseFuture][8]<S, C>

where S: [Send][27], C: [Send][27],

§

### impl<S, C> [Sync][28] for [ResponseFuture][8]<S, C>

where S: [Sync][28], C: [Sync][28],

§

### impl<S, C> [UnwindSafe][29] for [ResponseFuture][8]<S, C>

where S: [UnwindSafe][29], C: [UnwindSafe][29],
...
#### type [Error][81] = [Infallible][17]

The type returned in the event of a conversion error.

[Source][82]§

#### fn [try_from][83](value: U) -> [Result][14]<T, <T as [TryFrom][79]<U>>::[Error][84]>
...
where F: [Future][12]<Output = [Result][14]<T, E>> \+ ?[Sized][32],
...
#### fn try_poll_unpin( &mut self, cx: &mut [Context][22]<'_>, ) -> [Poll][23]<[Result][14]<Self::Ok, Self::Error>>
...
#### fn [try_into][93](self) -> [Result][14]<U, <U as [TryFrom][79]<T>>::[Error][84]>
...
Attaches the current [default][95] [`Subscriber`][94] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/extract/connect_info.rs.html#120-124
   [6]: struct.IntoMakeServiceWithConnectInfo.html (struct axum::extract::connect_info::IntoMakeServiceWithConnectInfo)
   [7]: https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html (trait core::fmt::Debug)
   [8]: struct.ResponseFuture.html (struct axum::extract::connect_info::ResponseFuture)
   ...
   [15]: ../../middleware/struct.AddExtension.html (struct axum::middleware::AddExtension)
   [16]: ../struct.ConnectInfo.html (struct axum::extract::ConnectInfo)
   [17]: https://doc.rust-lang.org/nightly/core/convert/enum.Infallible.html (enum core::convert::Infallible)
   [18]: https://doc.rust-lang.org/nightly/core/future/future/trait.Future.html#associatedtype.Output
