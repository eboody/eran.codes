<!-- Generated from rustdoc HTML: error_handling/struct.HandleErrorLayer.html -->
...
# Struct HandleErrorLayer Copy item path
...
[`Layer`] that applies [`HandleError`][5] which is a [`Service`] adapter that handles errors by converting them into responses.

See [module docs][6] for more details on axum’s error handling model.

## Implementations§

[Source][7]§

### impl<F, T> [HandleErrorLayer][8]<F, T>
...
### impl<F, T> [Clone][11] for [HandleErrorLayer][8]<F, T>

where F: [Clone][11],

[Source][12]§

#### fn [clone][13](&self) -> Self
...
### impl<F, E> [Debug][17] for [HandleErrorLayer][8]<F, E>
...
### impl<S, F, T> Layer<S> for [HandleErrorLayer][8]<F, T>

where F: [Clone][11],

[Source][23]§

#### type Service = [HandleError][5]<S, F, T>
...
### impl<F, T> [Freeze][25] for [HandleErrorLayer][8]<F, T>

where F: [Freeze][25],

§

### impl<F, T> [RefUnwindSafe][26] for [HandleErrorLayer][8]<F, T>

where F: [RefUnwindSafe][26],

§

### impl<F, T> [Send][27] for [HandleErrorLayer][8]<F, T>

where F: [Send][27],

§

### impl<F, T> [Sync][28] for [HandleErrorLayer][8]<F, T>

where F: [Sync][28],

§

### impl<F, T> [Unpin][29] for [HandleErrorLayer][8]<F, T>

where F: [Unpin][29],

§

### impl<F, T> [UnwindSafe][30] for [HandleErrorLayer][8]<F, T>

where F: [UnwindSafe][30],
...
Attaches the current [default][97] [`Subscriber`][96] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: ../../src/axum/error_handling/mod.rs.html#23-26
   [5]: struct.HandleError.html (struct axum::error_handling::HandleError)
   [6]: index.html (mod axum::error_handling)
   [7]: ../../src/axum/error_handling/mod.rs.html#28-36
   [8]: struct.HandleErrorLayer.html (struct axum::error_handling::HandleErrorLayer)
   [9]: ../../src/axum/error_handling/mod.rs.html#30-35
   [10]: ../../src/axum/error_handling/mod.rs.html#38-48
   [11]: https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html (trait core::clone::Clone)
   [12]: ../../src/axum/error_handling/mod.rs.html#42-47
   [13]: https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone
   [14]: https://doc.rust-lang.org/nightly/src/core/clone.rs.html#245-247
   [15]: https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#method.clone_from
   [16]: ../../src/axum/error_handling/mod.rs.html#50-56
   [17]: https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html (trait core::fmt::Debug)
   [18]: ../../src/axum/error_handling/mod.rs.html#51-55
   ...
   [22]: ../../src/axum/error_handling/mod.rs.html#58-67
   [23]: ../../src/axum/error_handling/mod.rs.html#62
   [24]: ../../src/axum/error_handling/mod.rs.html#64-66
