<!-- Generated from rustdoc HTML: middleware/future/struct.MapRequestResponseFuture.html -->
...
# Struct MapRequestResponseFuture Copy item path

[Source][5]
``` 
pub struct MapRequestResponseFuture { /* private fields */ }
```

Expand description

Response future for [`MapRequest`][6].
...
Attaches the current [default][98] [`Subscriber`][97] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [3]: ../../index.html
   [4]: ../index.html
   [5]: ../../../src/axum/middleware/map_request.rs.html#337-339
   [6]: ../struct.MapRequest.html (struct axum::middleware::MapRequest)
   [7]: ../../../src/axum/middleware/map_request.rs.html#349-353
   [8]: https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html (trait core::fmt::Debug)
   [9]: struct.MapRequestResponseFuture.html (struct axum::middleware::future::MapRequestResponseFuture)
   [10]: ../../../src/axum/middleware/map_request.rs.html#350-352
   ...
   [21]: ../../../src/axum/middleware/map_request.rs.html#344-346
