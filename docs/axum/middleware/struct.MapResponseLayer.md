<!-- Generated from rustdoc HTML: middleware/struct.MapResponseLayer.html -->
...
# Struct MapResponseLayer Copy item path
...
### impl<F, S, T> [Clone][7] for [MapResponseLayer][8]<F, S, T>
...
### impl<F, S, T> [Debug][14] for [MapResponseLayer][8]<F, S, T>
...
### impl<S, I, F, T> Layer<I> for [MapResponseLayer][8]<F, S, T>

where F: [Clone][7], S: [Clone][7],

[Source][20]§

#### type Service = [MapResponse][21]<F, S, I, T>
...
### impl<F, S, T> [Freeze][23] for [MapResponseLayer][8]<F, S, T>

where F: [Freeze][23], S: [Freeze][23],

§

### impl<F, S, T> [RefUnwindSafe][24] for [MapResponseLayer][8]<F, S, T>

where F: [RefUnwindSafe][24], S: [RefUnwindSafe][24],

§

### impl<F, S, T> [Send][25] for [MapResponseLayer][8]<F, S, T>

where F: [Send][25], S: [Send][25],

§

### impl<F, S, T> [Sync][26] for [MapResponseLayer][8]<F, S, T>

where F: [Sync][26], S: [Sync][26],

§

### impl<F, S, T> [Unpin][27] for [MapResponseLayer][8]<F, S, T>

where F: [Unpin][27], S: [Unpin][27],

§

### impl<F, S, T> [UnwindSafe][28] for [MapResponseLayer][8]<F, S, T>
...
Attaches the current [default][95] [`Subscriber`][94] to this type, returning a [`WithDispatch`] wrapper. Read more
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: ../../src/axum/middleware/map_response.rs.html#153-157
   [5]: fn.map_response.html (fn axum::middleware::map_response)
   [6]: ../../src/axum/middleware/map_response.rs.html#159-171
   [7]: https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html (trait core::clone::Clone)
   [8]: struct.MapResponseLayer.html (struct axum::middleware::MapResponseLayer)
   [9]: ../../src/axum/middleware/map_response.rs.html#164-170
   ...
   [13]: ../../src/axum/middleware/map_response.rs.html#190-201
   [14]: https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html (trait core::fmt::Debug)
   [15]: ../../src/axum/middleware/map_response.rs.html#194-200
   ...
   [19]: ../../src/axum/middleware/map_response.rs.html#173-188
   [20]: ../../src/axum/middleware/map_response.rs.html#178
   [21]: struct.MapResponse.html (struct axum::middleware::MapResponse)
   [22]: ../../src/axum/middleware/map_response.rs.html#180-187
