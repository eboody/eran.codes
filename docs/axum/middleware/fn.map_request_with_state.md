<!-- Generated from rustdoc HTML: middleware/fn.map_request_with_state.html -->
...
# Function map_request_with_state Copy item path

[Source][4]
``` 
pub fn map_request_with_state<F, S, T>(
    state: S,
    f: F,
) -> [MapRequestLayer][5]<F, S, T>
```
...
```
   ...
   [2]: index.html
   [3]: ../index.html
   [4]: ../../src/axum/middleware/map_request.rs.html#159-165
