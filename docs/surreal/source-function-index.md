# Surreal Function Index (From Source)

Source: https://github.com/gnat/surreal/blob/main/surreal.js

## Core object methods
- `	sugar(e) {` (line 11)
- `	me(selector=null, start=document, warning=true) {` (line 57)
- `	any(selector, start=document, warning=true) {` (line 69)
- `	run(e, f) {` (line 79)
- `	remove(e) {` (line 86)
- `	classAdd(e, name) {` (line 92)
- `	classRemove(e, name) {` (line 100)
- `	classToggle(e, name, force) {` (line 108)
- `	styles(e, value) {` (line 119)
- `	on(e, name, f) {` (line 136)
- `	off(e, name, f) {` (line 141)
- `	offAll(e) {` (line 146)
- `	disable(e) {` (line 152)
- `	enable(e) {` (line 158)
- `	send(e, name, detail=null) {` (line 165)
- `	halt(ev, keepBubbling=false, keepDefault=false) {` (line 174)
- `	attribute(e, name, value=undefined) {` (line 182)
- `	globalsAdd() {` (line 210)
- `	isNode(e) {` (line 219)
- `	isNodeList(e) {` (line 223)
- `	isSelector(selector="", start=document, warning=true) {` (line 227)

## Plugin functions
- `function pluginEffects(e) {` (line 243)
