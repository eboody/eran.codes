...
Datastar provides backend SDKs that can (optionally) simplify the process of generating [SSE events](sse_events.md) specific to Datastar. 
...
_Maintainer:[Greg H](https://github.com/SpiralOSS)  
Contributors: [Ryan Riley](https://github.com/panesofglass)_
...
_Maintainer:[mailq](https://github.com/mailq)  
Contributors: [Peter Humulock](https://github.com/rphumulock), [Tom D.](https://github.com/anastygnome)_
...
_Maintainer:[Felix Ingram](https://github.com/lllama)  
Contributors: [Chase Sterling](https://github.com/gazpachoking)_
...
_Maintainer:[Glen De Cauwsemaecker](https://github.com/glendc)  
Contributors: [Johnathan Stevers](https://github.com/jmstevers)_
...
_Maintainer:[Edu Wass](https://github.com/eduwass)  
Contributors: [Patrick Marchand](https://github.com/Superpat)_
...
_Maintainer:[Kaushik Chakraborty](https://github.com/kaychaks)_
