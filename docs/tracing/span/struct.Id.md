<!-- Generated from rustdoc HTML: span/struct.Id.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/span/struct.Id.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/span/struct.Id.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/span/struct.Id.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/span/struct.Id.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/span/struct.Id.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/span/struct.Id.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/span/struct.Id.html)
...
They are generated by [`Subscriber`](../trait.Subscriber.md "trait tracing::Subscriber")s for each span as it is created, by the [`new_span`](../trait.Subscriber.md#tymethod.new_span "method tracing::Subscriber::new_span") trait method. See the documentation for that method for more information on span ID generation.

## Implementations§

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#62)§

### impl [Id](struct.Id.md "struct tracing::span::Id")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#71)

#### pub fn from_u64(u: [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)) -> [Id](struct.Id.md "struct tracing::span::Id")
...
#### pub const fn from_non_zero_u64(id: [NonZero](https://doc.rust-lang.org/nightly/core/num/nonzero/struct.NonZero.html "struct core::num::nonzero::NonZero")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)>) -> [Id](struct.Id.md "struct tracing::span::Id")

Constructs a new span ID from the given `NonZeroU64`.

Unlike [`Id::from_u64`](struct.Id.md#method.from_u64 "associated function tracing::span::Id::from_u64"), this will never panic.

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#86)

#### pub fn into_u64(&self) -> [u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)

Returns the span’s ID as a `u64`.

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#94)

#### pub const fn into_non_zero_u64(&self) -> [NonZero](https://doc.rust-lang.org/nightly/core/num/nonzero/struct.NonZero.html "struct core::num::nonzero::NonZero")<[u64](https://doc.rust-lang.org/nightly/std/primitive.u64.html)>
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [Id](struct.Id.md "struct tracing::span::Id")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#17)§

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [Id](struct.Id.md "struct tracing::span::Id")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Id](struct.Id.md "struct tracing::span::Id")
...
### impl<'a> [From](https://doc.rust-lang.org/nightly/core/convert/trait.From.html "trait core::convert::From")<&'a [Id](struct.Id.md "struct tracing::span::Id")> for [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Id](struct.Id.md "struct tracing::span::Id")>

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#100)§

#### fn [from](https://doc.rust-lang.org/nightly/core/convert/trait.From.html#tymethod.from)(id: &'a [Id](struct.Id.md "struct tracing::span::Id")) -> [Option](https://doc.rust-lang.org/nightly/core/option/enum.Option.html "enum core::option::Option")<[Id](struct.Id.md "struct tracing::span::Id")>

Converts to this type from the input type.

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#17)§

### impl [Hash](https://doc.rust-lang.org/nightly/core/hash/trait.Hash.html "trait core::hash::Hash") for [Id](struct.Id.md "struct tracing::span::Id")
...
### impl [PartialEq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html "trait core::cmp::PartialEq") for [Id](struct.Id.md "struct tracing::span::Id")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#17)§

#### fn [eq](https://doc.rust-lang.org/nightly/core/cmp/trait.PartialEq.html#tymethod.eq)(&self, other: &[Id](struct.Id.md "struct tracing::span::Id")) -> [bool](https://doc.rust-lang.org/nightly/std/primitive.bool.html)
...
### impl [Eq](https://doc.rust-lang.org/nightly/core/cmp/trait.Eq.html "trait core::cmp::Eq") for [Id](struct.Id.md "struct tracing::span::Id")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#17)§

### impl [StructuralPartialEq](https://doc.rust-lang.org/nightly/core/marker/trait.StructuralPartialEq.html "trait core::marker::StructuralPartialEq") for [Id](struct.Id.md "struct tracing::span::Id")

## Auto Trait Implementations§

§

### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Id](struct.Id.md "struct tracing::span::Id")

§

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Id](struct.Id.md "struct tracing::span::Id")

§

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Id](struct.Id.md "struct tracing::span::Id")

§

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Id](struct.Id.md "struct tracing::span::Id")

§

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Id](struct.Id.md "struct tracing::span::Id")

§

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Id](struct.Id.md "struct tracing::span::Id")
