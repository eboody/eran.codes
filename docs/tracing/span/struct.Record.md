<!-- Generated from rustdoc HTML: span/struct.Record.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/span/struct.Record.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/span/struct.Record.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/span/struct.Record.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/span/struct.Record.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/span/struct.Record.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/span/struct.Record.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/span/struct.Record.html)
...
### impl<'a> [Record](struct.Record.md "struct tracing::span::Record")<'a>

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/span.rs.html#219)

#### pub fn new(values: &'a [ValueSet](../field/struct.ValueSet.md "struct tracing::field::ValueSet")<'a>) -> [Record](struct.Record.md "struct tracing::span::Record")<'a>
...
Records all the fields in this `Record` with the provided [Visitor](../field/trait.Visit.md "trait tracing::field::Visit").
...
Returns the number of fields that would be visited from this `Record` when [`Record::record()`](struct.Record.md#method.record "method tracing::span::Record::record") is called
...
### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Record](struct.Record.md "struct tracing::span::Record")<'a>
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Record](struct.Record.md "struct tracing::span::Record")<'a>

§

### impl<'a> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Record](struct.Record.md "struct tracing::span::Record")<'a>

§

### impl<'a> ![Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Record](struct.Record.md "struct tracing::span::Record")<'a>

§

### impl<'a> ![Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Record](struct.Record.md "struct tracing::span::Record")<'a>

§

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Record](struct.Record.md "struct tracing::span::Record")<'a>

§

### impl<'a> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Record](struct.Record.md "struct tracing::span::Record")<'a>
