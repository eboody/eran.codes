<!-- Generated from rustdoc HTML: span/struct.Entered.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/span/struct.Entered.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/span/struct.Entered.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/span/struct.Entered.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/span/struct.Entered.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/span/struct.Entered.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/span/struct.Entered.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/span/struct.Entered.html)
...
# Struct Entered Copy item path

[Source](../../src/tracing/span.rs.html#388-390)
...
This is returned by the [`Span::enter`](../struct.Span.md#method.enter "method tracing::Span::enter") function.

## Trait Implementations§

[Source](../../src/tracing/span.rs.html#386)§

### impl<'a> [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>
...
[Source](../../src/tracing/span.rs.html#1565-1570)§

### impl [Drop](https://doc.rust-lang.org/nightly/core/ops/drop/trait.Drop.html "trait core::ops::drop::Drop") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'_>

[Source](../../src/tracing/span.rs.html#1567-1569)§
...
### impl<'a> [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>

§

### impl<'a> ![RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>

§

### impl<'a> [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>

§

### impl<'a> [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>

§

### impl<'a> [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>

§

### impl<'a> ![UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [Entered](struct.Entered.md "struct tracing::span::Entered")<'a>
