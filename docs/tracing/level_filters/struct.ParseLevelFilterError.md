<!-- Generated from rustdoc HTML: level_filters/struct.ParseLevelFilterError.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/level_filters/struct.ParseLevelFilterError.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/level_filters/struct.ParseLevelFilterError.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/level_filters/struct.ParseLevelFilterError.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/level_filters/struct.ParseLevelFilterError.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/level_filters/struct.ParseLevelFilterError.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/level_filters/struct.ParseLevelFilterError.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/level_filters/struct.ParseLevelFilterError.html)
...
# Struct ParseLevelFilterError Copy item path
...
### impl [Clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html "trait core::clone::Clone") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/metadata.rs.html#242)§

#### fn [clone](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)(&self) -> [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

§

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

§

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

§

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

§

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")

§

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [ParseLevelFilterError](struct.ParseLevelFilterError.md "struct tracing::level_filters::ParseLevelFilterError")
