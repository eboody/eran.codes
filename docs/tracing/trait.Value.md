<!-- Generated from rustdoc HTML: trait.Value.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/trait.Value.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/trait.Value.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/trait.Value.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/trait.Value.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/trait.Value.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/trait.Value.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/trait.Value.html)
...
[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/field.rs.html#350)
    ...
    pub trait Value: Sealed {
        // Required method
        fn record(&self, key: &[Field](field/struct.Field.md "struct tracing::field::Field"), visitor: &mut dyn [Visit](field/trait.Visit.md "trait tracing::field::Visit"));
    }
...
Implementors of `Value` may call the appropriate typed recording methods on the [visitor](field/trait.Visit.md "trait tracing::field::Visit") passed to their `record` method in order to indicate how their data should be recorded.
...
### impl [Value](trait.Value.md "trait tracing::Value") for [Empty](field/struct.Empty.md "struct tracing::field::Empty")

[Source](https://docs.rs/tracing-core/0.1.36/x86_64-unknown-linux-gnu/src/tracing_core/field.rs.html#744-746)§

### impl<T> [Value](trait.Value.md "trait tracing::Value") for [DebugValue](field/struct.DebugValue.md "struct tracing::field::DebugValue")<T>
...
### impl<T> [Value](trait.Value.md "trait tracing::Value") for [DisplayValue](field/struct.DisplayValue.md "struct tracing::field::DisplayValue")<T>
