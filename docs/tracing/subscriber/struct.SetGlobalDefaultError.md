<!-- Generated from rustdoc HTML: subscriber/struct.SetGlobalDefaultError.html -->
<!-- Source: https://docs.rs/tracing/latest/tracing/subscriber/struct.SetGlobalDefaultError.html -->
...
[ Docs.rs ](/)
  ...
  * tracing-0.1.44
    ...
    * tracing 0.1.44 
    * [ Permalink ](/tracing/0.1.44/tracing/subscriber/struct.SetGlobalDefaultError.html "Get a link to this specific version")
  ...
  * Platform
    * [aarch64-apple-darwin](/crate/tracing/latest/target-redirect/aarch64-apple-darwin/tracing/subscriber/struct.SetGlobalDefaultError.html)
    * [aarch64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/aarch64-unknown-linux-gnu/tracing/subscriber/struct.SetGlobalDefaultError.html)
    * [i686-pc-windows-msvc](/crate/tracing/latest/target-redirect/i686-pc-windows-msvc/tracing/subscriber/struct.SetGlobalDefaultError.html)
    * [x86_64-pc-windows-msvc](/crate/tracing/latest/target-redirect/x86_64-pc-windows-msvc/tracing/subscriber/struct.SetGlobalDefaultError.html)
    * [x86_64-unknown-linux-gnu](/crate/tracing/latest/target-redirect/tracing/subscriber/struct.SetGlobalDefaultError.html)
...
### impl [Debug](https://doc.rust-lang.org/nightly/core/fmt/trait.Debug.html "trait core::fmt::Debug") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")
...
### impl [Display](https://doc.rust-lang.org/nightly/core/fmt/trait.Display.html "trait core::fmt::Display") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")
...
### impl [Error](https://doc.rust-lang.org/nightly/core/error/trait.Error.html "trait core::error::Error") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")
...
### impl [Freeze](https://doc.rust-lang.org/nightly/core/marker/trait.Freeze.html "trait core::marker::Freeze") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")

§

### impl [RefUnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.RefUnwindSafe.html "trait core::panic::unwind_safe::RefUnwindSafe") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")

§

### impl [Send](https://doc.rust-lang.org/nightly/core/marker/trait.Send.html "trait core::marker::Send") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")

§

### impl [Sync](https://doc.rust-lang.org/nightly/core/marker/trait.Sync.html "trait core::marker::Sync") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")

§

### impl [Unpin](https://doc.rust-lang.org/nightly/core/marker/trait.Unpin.html "trait core::marker::Unpin") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")

§

### impl [UnwindSafe](https://doc.rust-lang.org/nightly/core/panic/unwind_safe/trait.UnwindSafe.html "trait core::panic::unwind_safe::UnwindSafe") for [SetGlobalDefaultError](../dispatcher/struct.SetGlobalDefaultError.md "struct tracing::dispatcher::SetGlobalDefaultError")
